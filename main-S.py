...
def create_daily_csv(box_id, enter_time, exit_time, worked_time, df, date):
    ...
    with open(os.path.join(report_dir, "{}S".format(yearly_report), daily_report, "report-{}.csv".format(daily_report)), "a") as csv_file:
        writer = csv.writer(csv_file, delimiter=';')
        writer.writerow(["BOX-{}".format(box_id), enter_time, exit_time, worked_time])

    with open(os.path.join(report_dir, "{}S".format(yearly_report), monthly_report, box_id_dir, daily_dir, "report-{}.csv".format(monthly_report)), "a") as csv_file:
        writer = csv.writer(csv_file, delimiter=',')
